...
export const _mock = {
  ...
  image: {
    ...
    avatar: (index: number) =>
      `src/assets/images/mock/avatar/avatar-${index + 1}.webp`,
    travel: (index: number) =>
      `src/assets/images/mock/travel/travel-${index + 1}.webp`,
    course: (index: number) =>
      `src/assets/images/mock/course/course-${index + 1}.webp`,
    company: (index: number) =>
      `src/assets/images/mock/company/company-${index + 1}.webp`,
    product: (index: number) =>
      `src/assets/images/mock/m-product/product-${index + 1}.webp`,
    portrait: (index: number) =>
      `src/assets/images/mock/portrait/portrait-${index + 1}.webp`,
  },
};
