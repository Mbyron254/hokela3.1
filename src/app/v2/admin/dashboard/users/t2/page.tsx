...
export default function T2Users() {
  const [currentTab, setCurrentTab] = useState('active');
  const [selectedRows, setSelectedRows] = useState<string[]>([]);
  
  const usersQueryFilters = { clientTier2Id: null, page: 0, pageSize: 10 };
  
  const {
    refetch: reloadT2UsersActive,
    data: t2UsersActive,
    loading: loadingT2UsersActive,
  } = GQLQuery({
  ...
  const {
    refetch: reloadT2UsersRecycled,
    data: t2UsersRecycled,
    loading: loadingT2UsersRecycled,
  } = GQLQuery({
