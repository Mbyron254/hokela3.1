...
const LINKS = [
  {
    headline: 'Hokela Interactive',
    children: [
      { name: 'Trending', href: paths.trending },
      { name: 'Articles', href: paths.articles },
      { name: 'People', href: paths.people },
      { name: 'Learning', href: paths.jobs },
    ],
  },
  {
    headline: 'Legal',
  ...
  { headline: 'Contact', children: [{ name: 'byron@support.co.ke', href: '#' }] },
];
    ...
    >
      <Container>
        ...
        <Box sx={{ mt: 1, typography: 'caption' }}>
          © All rights reserved.
          <br /> made by
          <Link href="https://minimals.cc/"> byron maurice </Link>
        </Box>
      </Container>
    </Box>
  );
